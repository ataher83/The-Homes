...
const OurAgents = () => {
    return (
        <div className="flex gap-5">
            ...
            <div className="py-16">
                <p className="text-center text-3xl font-semibold   animate__animated animate__bounceInLeft">Meet Our Agents</p>
                <p className="text-center animate__animated animate__bounceIn ">Meet our team of professional agents, who will help you find your dream house</p>
